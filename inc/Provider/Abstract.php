 ...
 */
abstract class VRPaymentProviderAbstract
{
    ...
    private function loadData()
    {
        ...
        if ($cachedData !== null) {
            $decoded = VRPaymentTools::base64Decode($cachedData, true);
            if ($decoded === false) {
                $decoded = $cachedData;
            }
        ...
        try {
            ...
            Cache::store($this->cacheKey, VRPaymentTools::base64Encode(serialize($this->data)));
